...
- **TagLib#** (TagLibSharp): For reading and writing image metadata. Please note the included version 
  in the Assemblies folder is a modified build to support more image files.
  You may replace it with the official TagLib# if desired.
